        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover data-table'>
           ...
           <tbody> 
                ...
                <td><div class='text-center'><?php if ( $row['status'] == 'Active' ){ echo '<i class="fas fa-circle" style="color:green;"></i> Active';} else if ($row['status'] == 'Expired') { echo '<i class="fas fa-circle" style="color:red;"></i> Expired';} else { echo '<i class="fas fa-circle" style="color:orange;"></i> Pending';}?></div></td>
