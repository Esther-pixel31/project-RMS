        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" id="mask-phone" name="contact" placeholder="*07********" class="span8 mask text">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- Kshs 5500 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- Kshs 3500 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- Kshs 4000 per month</small></label>
              </div>
            </div>
